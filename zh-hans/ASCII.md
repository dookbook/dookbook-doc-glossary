...
**ASCII**（**美国信息交换标准代码**）是计算机用于将字母，数字，标点和控制代码转换为数字形式的最流行的编码方法之一。自2007年以来，[[UTF-8]]取代了[Web](/en/glossary/World_Wide_Web）。

ASCII是由*美国国家标准学会*(*ANSI*)制定，被*国际标准化组织*（*[[ISO]]*）定为国际标准，称为**ISO 646**标准。
